 ...
 * @class Core.WSDLService.XMLSchemaTypes
 * @static
 */
var XMLSchemaTypes = {
	/**
     ...
     * @private
     * @property {Core.WSDLService.XMLSchemaTypes.Convert} _convert
     */
    _convert: {
        /**
         ...
         * 
         * @method string
         * @member Core.WSDLService.XMLSchemaTypes.Convert
        ...
        boolean: function(name, v, toString){
            ...
            else return new Error(format('Value "%s" is not boolean', v))
        },
